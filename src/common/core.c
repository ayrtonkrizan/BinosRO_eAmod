...
static void display_title(void)
{
	...
	ShowMessage(""CL_XXBL"          ("CL_BT_YELLOW"            Servidores Ragnarok Personalizado            "CL_XXBL")"CL_CLL""CL_NORMAL"\n");
	...
	ShowMessage(""CL_XXBL"          ("CL_BOLD" ( D   o   u   g   l   a   s ) ( S   a   n   t   o   s ) "CL_XXBL")"CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_XXBL"          ("CL_BOLD"  \\_/ \\_/ \\_/ \\_/ \\_/ \\_/ \\_/   \\_/ \\_/ \\_/ \\_/ \\_/ \\_/  "CL_XXBL")"CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_XXBL"          ("CL_BOLD"                                                         "CL_XXBL")"CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_WTBL"          (=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=)"CL_CLL""CL_NORMAL"\n\n");
...
void usercheck(void)
{
	...
	ShowWarning ("Você está rodando o emulador com privilégios root.\n");
	ShowWarning ("É desnecessário e perigoso você executar o emulador com privilégios root.\n");
	sleep(3);
    }
#endif
}
